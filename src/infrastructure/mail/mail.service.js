...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
         ...
         */
        MailService_1.prototype.sendOtpResetPassword = function (to, fullName, identifier, otp, ipAddress) {
            return __awaiter(this, void 0, void 0, function () {
                var otpDigits, error_1;
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.mailerService.sendMail({
                                    ...
                                    context: {
                                        ...
                                        otpDigits: otpDigits,
                                        ipAddress: ipAddress !== null && ipAddress !== void 0 ? ipAddress : 'Không xác định',
                                    },
                                })];
                        case 2:
                            _a.sent();
                            this.logger.log("\uD83D\uDCE7 OTP email g\u1EEDi th\u00E0nh c\u00F4ng \u0111\u1EBFn: ".concat(to));
                            return [3 /*break*/, 4];
                        case 3:
                            error_1 = _a.sent();
                            this.logger.error("\u274C G\u1EEDi email th\u1EA5t b\u1EA1i \u0111\u1EBFn ".concat(to, ": ").concat(error_1.message));
                            return [3 /*break*/, 4];
