...
var handlebars_adapter_1 = require("@nestjs-modules/mailer/adapters/handlebars.adapter");
            ...
            imports: [
                mailer_1.MailerModule.forRootAsync({
                    ...
                    useFactory: function (config) { return ({
                        ...
                        defaults: {
                            from: "\"".concat(config.get('MAIL_FROM_NAME', 'RescueSystem'), "\" <").concat(config.get('MAIL_USER'), ">"),
                        },
                        template: {
